...
const TrandingProduct = () => {
    ...
    return (
        <div>
                        ...
                        <div className="card w-96 bg-base-300  h-[550px] shadow-xl rounded-lg">
                            ...
                            <div className="card-body bg-base-100  rounded-b">
                                ...
                                <div className="card-actions justify-between">
                                    <div className="btn btn-outline bg-[#9d4697] btn-xs text-white"> <GiVote></GiVote>up vote</div>
                                    <div className="btn btn-outline bg-[#9d4697] btn-xs text-white"><GiVote></GiVote>down vote</div>
                                </div>
                            </div>
                        </div>
                    </div>)
          ...
          <Link to="/product"> <button  className="btn bg-[#9d4697] text-white hover:text-black">Show All Product</button></Link>
           </div>
        </div>
    );
};
